...
class CreatePhieuNhapKhoRequest extends FormRequest
{
    /**
    ...
    {
        return [
            // Thêm các quy tắc validation cho PhieuNhapKho ở đây
            'ma_phieu_nhap_kho' => 'required|string|max:255|unique:phieu_nhap_khos,ma_phieu_nhap_kho',

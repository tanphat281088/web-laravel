...
class UpdateDonViTinhRequest extends FormRequest
{
  /**
  ...
  {
    return [
      // Thêm các quy tắc validation cho cập nhật DonViTinh ở đây
      'ten_don_vi' => 'sometimes|required|string|max:255|unique:don_vi_tinhs,ten_don_vi,' . $this->id,
      'ky_hieu' => 'sometimes|nullable|string|max:255|unique:don_vi_tinhs,ky_hieu,' . $this->id,
